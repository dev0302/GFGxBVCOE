...
function App() {
  ...
  const dashboardLikeMotionKey = (() => {
    ...
    if (location.pathname.startsWith("/vectorvision-admin"))
      return "/vectorvision-admin";
    if (location.pathname.startsWith("/leadership-transition"))
      return "/leadership-transition";
    if (location.pathname.startsWith("/dashboard/"))
      return `/dashboard/${location.pathname.split("/")[2] || "unknown"}`;
              ...
              <div className="min-h-screen flex flex-col overflow-x-hidden">
                ...
                <AnimatePresence mode="wait">
                  <motion.main
                    ...
                    initial={
                      shouldAnimatePage ? { opacity: 0, scale: 0.98 } : false
                    }
                    ...
                    <Routes location={location}>
                      ...
                      <Route path="/em-dashboard">
                        ...
                        <Route element={<EventDashboardLayout />}>
                          ...
                          <Route
                            path="vector-vision"
                            element={<VectorVision />}
                          />
                          <Route
                            path="force-delete"
                            element={<ForceDeletePermissions />}
                          />
                      ...
                      <Route
                        path="/dashboard/member/:department"
                        element={<MemberDashboard />}
                      />
                      <Route
                        path="/dashboard/:departmentKey"
                      ...
                      <Route
                        path="/dashboard"
                        element={<AdminSignupConfig />}
                      />
                      <Route
                        path="/leadership-transition"
                        element={<LeadershipTransitionLayout />}
                      >
                        <Route
                          index
                          element={
