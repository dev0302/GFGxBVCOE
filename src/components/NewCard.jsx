  ...
  return (
    <>
      <div className="flex justify-center items-center font-nunito text-richblack-25">
        <div
          className={`relative ${loaded ? "loaded" : ""} w-[280px] h-[420px]`}
        >
            ...
            <div className="p-5 py-6 flex flex-col gap-1 flex-grow">
              <div>
                <p className="text-lg font-bold font-montserrat flex items-center gap-1.5 text-richblack-25">
                  {name}
                  <span>
                    <img src={verify} className="h-4" alt="verified" />
                  </span>
                </p>
              ...
              <div className="flex justify-between items-center text-sm">
                ...
                >
                  View Timeline{" "}
                  <img src={activity} className="h-4 invert" alt="activity" />
                </button>
              </div>
            </div>
          </div>
      ...
      {isModalOpen && (
        <TimelineModal person={person} onClose={() => setIsModalOpen(false)} />
      )}
        ...
        >
          ...
          >
            <h3
              ...
              className="text-sm font-semibold text-cyan-400/90 uppercase tracking-wider mb-3"
            >
              Email
            </h3>
