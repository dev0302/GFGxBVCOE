...
import { userCanAccessLeadershipTransition } from "../../services/api";
import LeadershipTransitionSidebar from "./LeadershipTransitionSidebar";

export default function LeadershipTransitionLayout() {
  ...
  if (!userCanAccessLeadershipTransition(user)) {
    return (
      <div className="flex min-h-[calc(100vh-5rem)] w-full items-center justify-center bg-[#1e1e2f]">
        <Navigate to="/" replace />
      </div>
