...
function ImageGrid() {
  ...
  return (
    <div ref={containerRef} className="w-full bg-[#161629] py-20 relative">
      <div className="absolute inset-0 flex flex-col items-center justify-center text-richblack-25 z-10">
        <NavLink to="/gallery">
          <button className="relative overflow-hidden px-8 py-3 rounded-full group transition-all duration-500 ease-in-out font-semibold text-lg md:text-2xl text-richblack-25 backdrop-blur-sm bg-white/20">
