...
function ProfileDropDown({ onLogout, isDarkNavbar, avatarOnly = false, alignLeft = false, showChevron = false, onBeforeToggle }) {
      ...
      >
          ...
          <div className="flex items-center gap-3">
            {user.image ? (
              <img
                src={user.image}
                alt=""
                className="h-8 w-8 rounded-full object-cover border border-gray-500/50"
              />
            ) : (
        ...
        <div className="px-1 py-1.5">
          ...
          >
            ...
            <span className="flex-1">
              <span className="block text-xs font-medium">Jam The Web Result</span>
              <span className="block text-[10px] text-gray-500">View & edit scores</span>
            </span>
          </button>
          <button
            onClick={() => {
