        ...
        {loading ? (
          ...
          <div className="space-y-6">
            {configs.map((config) => (
              ...
              >
                <h2 className="text-lg font-semibold text-richblack-25 mb-1 flex items-center gap-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 rounded-lg bg-[#252536] border border-gray-500/40 text-richblack-25 placeholder-gray-500 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/20 outline-none text-sm"
                  />
                  <button
                    type="button"
                    onClick={() => handleAdd(config.department)}
                    disabled={adding[config.department]}
                    className="px-4 py-2 rounded-lg bg-cyan-600 hover:bg-cyan-500 text-richblack-25 font-medium text-sm disabled:opacity-50"
                  >
