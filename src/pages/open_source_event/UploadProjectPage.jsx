...
function UploadProjectPage() {
  ...
  const submitProject = async (event) => {
    ...
    const project = {
      ...
      maintainerLinkedIn: normalizeProfileUrl(form.maintainerLinkedIn),
      maintainerGithub: normalizeProfileUrl(form.maintainerGithub),
      accent: "#4ade80",
    };
    if (
      !project.name ||
      ...
      toast.error(
        "Complete the project details and all maintainer contact fields.",
      );
      return;
    }
    try {
        ...
        <div className="rounded-[26px] border border-white/[0.1] bg-[#1b1b2a]/90 p-6 shadow-2xl shadow-black/20 sm:p-9">
          ...
          <form onSubmit={submitProject} className="space-y-6">
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              />
              <Field
                label="Maintainer LinkedIn"
                name="maintainerLinkedIn"
                value={form.maintainerLinkedIn}
                onChange={updateField}
            ...
            <Field
              ...
              name="maintainerGithub"
              value={form.maintainerGithub}
              onChange={updateField}
